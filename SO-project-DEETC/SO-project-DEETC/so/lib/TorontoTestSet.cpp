...
//        cout << idx << " " << val << endl;
        ...
        pair<boost::unordered_map<int, int>::iterator, bool> p = courseStudentCounts.insert(pair<int, int>(idx, val));
...
/// ute92 has 1 blank lines but these are *ignored* so # students = 2049 instead 2050 -> blank line 921
